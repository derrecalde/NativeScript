...
var RadSideDrawer = /** @class */ (function (_super) {
    ...
    RadSideDrawer.prototype.bringMainContentOnTop = function () {
        this.viewController.view.bringSubviewToFront(this.mainContent.nativeViewProtected);
    };
    RadSideDrawer.prototype.reattachGestures = function () {
        ...
        this._ios.defaultSideDrawer.attachGesturesToView(this.mainContent.viewController.view.superview);
    };
    ...
    RadSideDrawer.prototype.onLayout = function (left, top, right, bottom) {
        ...
        if (!this.viewController) {
            ...
            this.moveDrawerRootToControllerView();
            if (this.areViewsRearranged) {
                this._enableMainContentUserInteraction();
    ...
    RadSideDrawer.prototype._enableMainContentUserInteraction = function () {
        this.changeUserInteractionEnabledToDrawerViews(false);
    };
    RadSideDrawer.prototype._disableMainContentUserInteraction = function () {
        this.changeUserInteractionEnabledToDrawerViews(true);
    };
    RadSideDrawer.prototype.moveDrawerRootToControllerView = function () {
        var overlayView = this.nativeViewProtected;
        if (this.mainContent && this.mainContent.viewController) {
            this.mainContent.viewController.view.addSubview(overlayView);
        }
    };
    RadSideDrawer.prototype.changeUserInteractionEnabledToDrawerViews = function (isEnabled) {
        if (this.isRootDrawer() && this.nativeViewProtected && this.nativeViewProtected.subviews) {
            for (var i = 0; i < this.nativeViewProtected.subviews.count; i++) {
                this.nativeViewProtected.subviews[i].userInteractionEnabled = isEnabled;
            }
            this.nativeViewProtected.userInteractionEnabled = isEnabled;
        }
    };
...
var TKSideDrawerDelegateImpl = /** @class */ (function (_super) {
    ...
    TKSideDrawerDelegateImpl.prototype.willShowSideDrawer = function (sideDrawer) {
        ...
        this._owner._disableMainContentUserInteraction();
    };
    ...
    TKSideDrawerDelegateImpl.prototype.didDismissSideDrawer = function (sideDrawer) {
        ...
        this._owner._enableMainContentUserInteraction();
    };
