...
export declare class RadSideDrawer extends commonModule.RadSideDrawer {
    ...
    _enableMainContentUserInteraction(): void;
    _disableMainContentUserInteraction(): void;
    private moveDrawerRootToControllerView;
    private changeUserInteractionEnabledToDrawerViews;
}
