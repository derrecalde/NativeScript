    ...
    if (!ListViewSwipeExecuteListener) {
        var ListViewSwipeExecuteListenerImpl = /** @class */ (function (_super) {
            ...
            function ListViewSwipeExecuteListenerImpl(owner) {
                var _this = _super.call(this) || this;
                _this.owner = owner;
                _this.swipeLimits = (owner.listViewLayout.scrollDirection === listViewCommonModule.ListViewScrollDirection.Vertical) ?
...
var RadListView = /** @class */ (function (_super) {
    ...
    RadListView.prototype.createNativeView = function () {
        ...
        if (this.listViewLayout) {
            this.listViewLayout._init(this);
        }
        else {
    ...
    RadListView.prototype.forceRefreshLayout = function () {
    ...
    RadListView.prototype.scrollToIndex = function (index, animate, snapMode) {
        ...
        var nativeIndex = this._getNativePosition(index);
        if (this._android) {
    ...
    RadListView.prototype.getScrollOffset = function () {
        return utilsModule.layout.toDeviceIndependentPixels(this._scrolledPixels);
    };
    RadListView.prototype.onScrolledPixelsChangedBy = function (by) {
        this._scrolledPixels += by;
        if (this._scrolledPixels < 0 || !this._isScrolled()) {
            this._scrolledPixels = 0;
        }
    };
    RadListView.prototype._isScrolled = function () {
        if (this._android) {
            if (this.listViewLayout.scrollDirection === listViewCommonModule.ListViewScrollDirection.Vertical) {
    ...
    RadListView.prototype._updateHeader = function () {
        ...
        var headerView = this.getViewForViewType(listViewCommonModule.ListViewViewType.HeaderView);
    ...
    RadListView.prototype._updateFooter = function () {
        ...
        var footerView = this.getViewForViewType(listViewCommonModule.ListViewViewType.FooterView);
    ...
    RadListView.prototype.updateLoadOnDemandBehavior = function () {
        ...
        if (!this._loadOnDemandBehavior) {
            var loadOnDemandView = this.getViewForViewType(listViewCommonModule.ListViewViewType.LoadOnDemandView);
            if (loadOnDemandView) {
    ...
    RadListView.prototype.updateReorderBehavior = function () {
        ...
        if (this.itemReorder) {
            if (!this._reorderBehavior) {
                ...
                this._reorderBehavior = (this.reorderMode === listViewCommonModule.ListViewReorderMode.HoldAndDrag) ?
    ...
    RadListView.prototype._getNativePosition = function (inputIndex) {
        return this.isDataOperationsEnabled ? this._listViewAdapter.getPosition(inputIndex) : inputIndex;
    };
    RadListView.prototype.getFirstVisiblePosition = function () {
        var firstIndex = undefined;
        var layoutManager = this._android.getLayoutManager();
        if (layoutManager) {
...
var ListViewLinearLayout = /** @class */ (function (_super) {
    ...
    ListViewLinearLayout.prototype.getLayoutManager = function () {
        return new androidx.recyclerview.widget.LinearLayoutManager(this.owner._context);
    };
...
var ListViewGridLayout = /** @class */ (function (_super) {
    ...
    ListViewGridLayout.prototype.getLayoutManager = function () {
        ...
        return new androidx.recyclerview.widget.GridLayoutManager(this.owner._context, this.spanCount);
    };
...
var ListViewStaggeredLayout = /** @class */ (function (_super) {
    ...
    ListViewStaggeredLayout.prototype.getLayoutManager = function () {
        var orientation = this.scrollDirection === listViewCommonModule.ListViewScrollDirection.Vertical ?
            androidx.recyclerview.widget.StaggeredGridLayoutManager.VERTICAL : androidx.recyclerview.widget.StaggeredGridLayoutManager.HORIZONTAL;
        this.spanCount = (this.spanCount ? this.spanCount : 2);
