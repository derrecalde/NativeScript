    ...
    TKListViewDelegateImpl.prototype.listViewShouldSwipeCellAtIndexPath = function (listView, cell, indexPath) {
        ...
        if (shouldSwipe) {
            ...
            if (swipeLimits) {
                ...
                owner.nativeViewProtected.cellSwipeThreshold = view_1.layout.toDeviceIndependentPixels(swipeLimits.threshold);
            }
        }
        return shouldSwipe;
    };
...
var RadListView = /** @class */ (function (_super) {
    ...
    RadListView.prototype.getItemTemplateContent = function (index, templateType) {
        ...
        var templatedView = this.getViewForViewType(commonModule.ListViewViewType.ItemView, templateType);
        // Proxy containers should not get treated as layouts.
        // Wrap them in a real layout as well.
        if (templatedView instanceof proxy_view_container_1.ProxyViewContainer) {
        ...
        var templatedSwipeView = this.getViewForViewType(commonModule.ListViewViewType.ItemSwipeView);
        // Proxy containers should not get treated as layouts.
        // Wrap them in a real layout as well.
        if (templatedSwipeView instanceof proxy_view_container_1.ProxyViewContainer) {
            var parentView = new stack_layout_1.StackLayout();
