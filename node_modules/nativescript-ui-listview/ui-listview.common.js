...
})(ListViewViewType = exports.ListViewViewType || (exports.ListViewViewType = {}));
...
var ListViewLayoutBase = /** @class */ (function (_super) {
    ...
    ListViewLayoutBase.scrollDirectionProperty = new view_1.Property({
        ...
        valueConverter: function (value) { return ListViewScrollDirection[value]; },
        valueChanged: function (target, oldValue, newValue) {
    ...
    ListViewLayoutBase.itemInsertAnimationProperty = new view_1.Property({
        ...
        valueConverter: function (value) { return ListViewItemAnimation[value]; },
        valueChanged: function (target, oldValue, newValue) {
...
var RadListView = /** @class */ (function (_super) {
    ...
    RadListView.prototype.logWarningIfNeeded = function () {
        if (this.parent instanceof stackLayoutModule.StackLayout || this.parent instanceof scroll_view_1.ScrollView) {
            if ((this.parent.orientation === "vertical" && this.height === "auto") ||
                this.parent.orientation === "horizontal" && this.width === "auto") {
                var requiredProperty = this.parent.orientation === "vertical" ? "height" : "width";
    ...
    RadListView.reorderModeProperty = new view_1.Property({
        ...
        valueConverter: function (value) { return ListViewReorderMode[value]; },
        valueChanged: function (target, oldValue, newValue) {
    ...
    RadListView.selectionBehaviorProperty = new view_1.Property({
        ...
        valueConverter: function (value) { return ListViewSelectionBehavior[value]; },
        valueChanged: function (target, oldValue, newValue) {
    ...
    RadListView.scrollPositionProperty = new view_1.Property({
        name: "scrollPosition",
        defaultValue: undefined,
        valueConverter: function (value) { return ListViewScrollPosition[value]; },
        valueChanged: function (target, oldValue, newValue) {
